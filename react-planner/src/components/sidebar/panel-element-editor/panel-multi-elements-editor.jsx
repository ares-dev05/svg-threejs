...
import {
  ...
  MODE_ROTATING_ITEM, MODE_RESIZE_ITEM_RIGHT_BOTTOM, MODE_RESIZE_ITEM_RIGHT_TOP
} from '../../../constants';
...
//export default function PanelMultiElementsEditor({state}, {projectActions, translator}) {
  ...
  render() {
    ...
    if (![MODE_IDLE, MODE_2D_ZOOM_IN, MODE_2D_ZOOM_OUT, MODE_2D_PAN,
      ...
      MODE_ROTATING_ITEM, MODE_RESIZE_ITEM_RIGHT_BOTTOM, MODE_RESIZE_ITEM_RIGHT_TOP, MODE_UPLOADING_IMAGE, MODE_FITTING_IMAGE].includes(mode)) return null;
